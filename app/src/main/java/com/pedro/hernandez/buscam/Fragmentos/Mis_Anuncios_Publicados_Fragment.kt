...
import com.pedro.hernandez.buscam.databinding.FragmentMisAnunciosPublicadosBinding
 ...
 * Use the [Mis_Anuncios_Publicados_Fragment.newInstance] factory method to
...
class Mis_Anuncios_Publicados_Fragment : Fragment() {
    ...
    private lateinit var anunciosAdaptador : AdaptadroAnuncio
        ...
        ref.orderByChild("uid").equalTo(firebaseAuth.uid!!)
            .addValueEventListener(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    anunciosAdaptador = AdaptadroAnuncio(mContext, anunciosArrayList)
