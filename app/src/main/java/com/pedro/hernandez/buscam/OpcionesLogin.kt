...
import com.pedro.hernandez.buscam.databinding.ActivityOpcionesLoginBinding
...
class OpcionesLogin : AppCompatActivity() {
    ...
    private fun googleLogin() {
        val googleSingIntent = mGoogleSingInClient.signInIntent
        googleSingInARL.launch(googleSingIntent)
    }
    ...
    private val googleSingInARL = registerForActivityResult(
        ...
        if (resultado.resultCode == RESULT_OK){
            ...
            try {
                ...
                autentificacionGoogle(cuenta.idToken)
            }catch(e:Exception) {
    ...
    private fun autentificacionGoogle(idToken: String?) {
        val credencial = GoogleAuthProvider.getCredential(idToken, null)
        firebaseAuth.signInWithCredential(credencial)
            .addOnSuccessListener {reaultadoAuth->
                if(reaultadoAuth.additionalUserInfo!!.isNewUser){
                    llenarInfoBD()
                }else{
