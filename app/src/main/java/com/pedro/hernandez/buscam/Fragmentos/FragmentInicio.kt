...
import com.pedro.hernandez.buscam.Adaptadores.AdaptadorCategoria
...
import com.pedro.hernandez.buscam.databinding.FragmentInicioBinding
...
class FragmentInicio : Fragment() {
    ...
    private lateinit var adaptadorAnuncio: AdaptadroAnuncio
    ...
    private fun cargarAnuncios(categoria: String){
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                adaptadorAnuncio = AdaptadroAnuncio(mContext, anuncioArrayList)
